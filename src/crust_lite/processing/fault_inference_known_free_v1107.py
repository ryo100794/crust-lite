...
from crust_lite.processing.scoring_known_free_v1107 import confidence_from_score, fault_score
...
def infer_faults(config: AppConfig, paths: ProjectPaths) -> dict[str, Any]:
    ...
    for raw_cluster_id, indices, inference_method in candidate_clusters:
        ...
        wave_score = 0.5
        score = fault_score(planarity, mech_score, gnss_score, wave_score)
        ...
        props = {
            ...
            "notes": "normal_analysis_candidate; external_geology_not_loaded",
            "is_sample_data": any(
    ...
    write_features(
        ...
        paths.data_processed / "inferred_faults.gpkg",
        {
            ...
            "known_structure_input": False,
            "known_structure_policy": "posthoc_overlay_and_correlation_only",
            **selection_stats,
        },
    )
    LOGGER.info(
