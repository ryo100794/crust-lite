...
def _write_manifest(config: AppConfig, paths: ProjectPaths, result: dict[str, Any]) -> None:
    ...
    gpu_handoff = {
        ...
        "voxel_depth_policy": "voxel_lod keeps compact density columns; sigma_z_m is resolution-only by default, while depth_uncertainty_km/depth_uncertainty_z_m remain primitive metadata and do not blur density unless explicitly enabled",
    }
