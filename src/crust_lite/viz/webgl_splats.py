...
def write_webgl_splat_preview(config: AppConfig, paths: ProjectPaths, rows: list[dict[str, Any]], is_sample: bool) -> None:
    ...
    metadata = {
        ...
        "near_surface_resolution_policy": "depth<=near_surface_depth_km uses denser depth quadrature and smaller vertical splat sigma; this improves shallow-state display without claiming a unique inversion",
