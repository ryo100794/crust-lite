...
def fetch_active_faults(
    ...
    raise RuntimeError(
        "active-fault materialization is forbidden in normal/sample analysis; known "
        "structures require explicit posthoc-known-structure mode and the verified "
        "external_geology GDrive cache resolver"
    )
    paths.ensure()
